...
- **Data Processing**: JSON handling, multi-file data processing
...
- How _often do actors appear in the most popular movie genres compared to less popular or niche genres?
